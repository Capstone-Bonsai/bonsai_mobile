                ...
                return SafeArea(
                  ...
                  children: [
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: _order.bonsaiDetail.map((bonsaiDetail) {
                          return Padding(
                            padding:
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          'Customer Name:${_order.customerName}',
                        ),
                        const SizedBox(height: 10),
                        Text(
                          'Số điện thoại: ${_order.customerPhoneNumber}',
                        ),
                        const SizedBox(height: 10),
                        Text(
                          'Địa chỉ: ${_order.address}',
                        ),
                      ],
                    ),
                    SizedBox(
                                  ...
                                  builder: (context) => AlertDialog(
                                        ...
                                        actions: <Widget>[
                                          ...
                                          TextButton(
                                            ...
                                            child: const Text('Có'),
                                            onPressed: () {
                                              sendImagesToAPI(context, _order.orderId,
                                                  imageFileList);
                                              Navigator.of(context).pop();
                                            },
                                          ),
